...
-- NOTE THIS VERSION ALLOWS NULLS TO HANDLE THE BORN AND DESCRIPTION ARE NULL FOR MADELEINE L' Engle
-- MANUALLY CHANGED THE TEXT (variable for quote) to "TEXT" due to long quotes
